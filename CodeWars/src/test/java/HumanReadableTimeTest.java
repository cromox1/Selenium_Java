...
public class HumanReadableTimeTest {
    ...
    public void Tests() {
        ...
        assertEquals("makeReadable(3661)", "01:01:01", HumanReadableTime.makeReadable(3661));
        assertEquals("makeReadable(3749)", "01:02:29", HumanReadableTime.makeReadable(3749));
        ...
        assertEquals("makeReadable(759999)", "211:06:39", HumanReadableTime.makeReadable(759999));
    }
}
